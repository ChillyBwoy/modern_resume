defmodule ModernResume.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:modern_ui, "~> 0.1",
       ...
       ref: "dec474f3e4304268366f3af0e7e90406e7839c4f"}
    ]
  end
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind modern_resume", "esbuild modern_resume"],
      "assets.deploy": [
        "tailwind modern_resume --minify",
