...
config :modern_resume, ModernResumeWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "uAbWdI98Y6ZG+MUQhF8JEEdxOUGqes2AkjkX3D/jrV4n+2y60xrVoW/5UNFEOTEO",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:modern_resume, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:modern_resume, ~w(--watch)]}
  ]
...
config :modern_resume, ModernResumeWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/modern_resume_web/(controllers|live|components|renderer)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :modern_resume, dev_routes: true
