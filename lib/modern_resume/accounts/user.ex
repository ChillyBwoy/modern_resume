defmodule ModernResume.Accounts.User do
  @moduledoc """
  The User schema.
  """
  use Ecto.Schema
  ...
  schema "users" do
    ...
    has_many :cvs, ModernResume.Resume.CV
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> Changeset.unsafe_validate_unique(:email, ModernResume.Repo)
  ...
  def email_changeset(user, attrs, opts \\ []) do
    ...
    |> case do
      ...
      %{} = changeset -> Changeset.add_error(changeset, :email, "did not change")
    end
  end
  ...
  def confirm_changeset(user) do
    ...
    Changeset.change(user, confirmed_at: now)
  end
  ...
  """
  def valid_password?(%ModernResume.Accounts.User{hashed_password: hashed_password}, password)
  ...
  def validate_current_password(changeset, password) do
    changeset = Changeset.cast(changeset, %{current_password: password}, [:current_password])
